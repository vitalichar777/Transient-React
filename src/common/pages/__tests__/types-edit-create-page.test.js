...
describe('TypesEditCreatePage', () => {
  ...
  const render = () => shallow(<TypesEditCreatePage {...props} />)
  ...
  describe('when initial load succeeds', () => {
    ...
    it('redirects to types page if submit succeeds', () => {
      ...
      node
        ...
        .props()
        .onClick()
      expect(props.history.push.firstCall.args[0]).toBe('/types')
    })
